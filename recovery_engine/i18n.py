...
STRINGS = {
    "en": {
        ...
        "prompt_custom_drive": "👉 Enter Path of Drive or Image file (e.g. /dev/rdisk4 or backup.img): ",
        ...
        "permission_error": "[!] ERROR: Root permission (sudo) required to access {dev}",
        "sudo_hint": "👉 Please run the command again with sudo:",
    ...
    "th": {
        ...
        "prompt_custom_drive": "👉 ป้อน Path ของ Drive หรือ Image file (เช่น /dev/rdisk4 หรือ backup.img): ",
        ...
        "permission_error": "[!] ERROR: ต้องการสิทธิ์ root (sudo) ในการเข้าถึง {dev}",
        "sudo_hint": "👉 กรุณารันคำสั่งใหม่อีกครั้งด้วย sudo:",
        "clone_title": "🛡️ DISK IMAGING & RAW CLONE ENGINE (BIT-BY-BIT DUMP)",
